...
class Student(Document):
	...
	# Validate Functions
	def set_title(self):
		"""Set student name by joining first, middle, and last name parts.
		This is equivalent to the server script:
		names = [doc.first_name, doc.middle_name, doc.last_name]
		doc.student_name = " ".join([name for name in names if name])
		"""
	...
	def before_save(self):
		"""Ensure student name is set before saving."""
		self.set_title()
